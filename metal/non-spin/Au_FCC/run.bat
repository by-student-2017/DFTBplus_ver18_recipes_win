...
gnuplot pdos.gp
move dos.png .\plot\dos_au.s.png
move dos.plot .\plot\dos_au.s.plot

find /v "KPT" <dos_au.2.out> dos.dat
gnuplot pdos.gp
move dos.png .\plot\dos_au.p.png
move dos.plot .\plot\dos_au.p.plot

find /v "KPT" <dos_au.3.out> dos.dat
gnuplot pdos.gp
move dos.png .\plot\dos_au.d.png
move dos.plot .\plot\dos_au.d.plot
