...
gnuplot pdos.gp
move dos.png .\plot\dos_pd.s.png
move dos.plot .\plot\dos_pd.s.plot

find /v "KPT" <dos_pd.2.out> dos.dat
gnuplot pdos.gp
move dos.png .\plot\dos_pd.p.png
move dos.plot .\plot\dos_pd.p.plot

find /v "KPT" <dos_pd.3.out> dos.dat
gnuplot pdos.gp
move dos.png .\plot\dos_pd.d.png
move dos.plot .\plot\dos_pd.d.plot
