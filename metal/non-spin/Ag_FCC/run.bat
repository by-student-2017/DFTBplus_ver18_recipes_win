...
gnuplot pdos.gp
move dos.png .\plot\dos_ag.s.png
move dos.plot .\plot\dos_ag.s.plot

find /v "KPT" <dos_ag.2.out> dos.dat
gnuplot pdos.gp
move dos.png .\plot\dos_ag.p.png
move dos.plot .\plot\dos_ag.p.plot

find /v "KPT" <dos_ag.3.out> dos.dat
gnuplot pdos.gp
move dos.png .\plot\dos_ag.d.png
move dos.plot .\plot\dos_ag.d.plot
