...
find /v "KPT" <dos_au.1.out> dos.dat
gnuplot pdos_spin.gp
move dos_spin.png .\plot\dos_au.s.png
move dos_spin.plot .\plot\dos_au.s.plot

find /v "KPT" <dos_au.2.out> dos.dat
gnuplot pdos_spin.gp
move dos_spin.png .\plot\dos_au.p.png
move dos_spin.plot .\plot\dos_au.p.plot

find /v "KPT" <dos_au.3.out> dos.dat
gnuplot pdos_spin.gp
move dos_spin.png .\plot\dos_au.d.png
move dos_spin.plot .\plot\dos_au.d.plot
