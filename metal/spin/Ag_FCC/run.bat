...
find /v "KPT" <dos_ag.1.out> dos.dat
gnuplot pdos_spin.gp
move dos_spin.png .\plot\dos_ag.s.png
move dos_spin.plot .\plot\dos_ag.s.plot

find /v "KPT" <dos_ag.2.out> dos.dat
gnuplot pdos_spin.gp
move dos_spin.png .\plot\dos_ag.p.png
move dos_spin.plot .\plot\dos_ag.p.plot

find /v "KPT" <dos_ag.3.out> dos.dat
gnuplot pdos_spin.gp
move dos_spin.png .\plot\dos_ag.d.png
move dos_spin.plot .\plot\dos_ag.d.plot
