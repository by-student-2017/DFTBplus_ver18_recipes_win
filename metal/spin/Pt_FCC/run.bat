...
move dos_spin.png .\plot\dos_pt.s.png
move dos_spin.plot .\plot\dos_pt.s.plot

find /v "KPT" <dos_pt.2.out> dos.dat
gnuplot pdos_spin.gp
move dos_spin.png .\plot\dos_pt.p.png
move dos_spin.plot .\plot\dos_pt.p.plot

find /v "KPT" <dos_pt.3.out> dos.dat
gnuplot pdos_spin.gp
move dos_spin.png .\plot\dos_pt.d.png
move dos_spin.plot .\plot\dos_pt.d.plot
