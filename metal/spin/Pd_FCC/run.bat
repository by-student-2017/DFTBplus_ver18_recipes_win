...
find /v "KPT" <dos_pd.1.out> dos.dat
gnuplot pdos_spin.gp
move dos_spin.png .\plot\dos_pd.s.png
move dos_spin.plot .\plot\dos_pd.s.plot

find /v "KPT" <dos_pd.2.out> dos.dat
gnuplot pdos_spin.gp
move dos_spin.png .\plot\dos_pd.p.png
move dos_spin.plot .\plot\dos_pd.p.plot

find /v "KPT" <dos_pd.3.out> dos.dat
gnuplot pdos_spin.gp
move dos_spin.png .\plot\dos_pd.d.png
move dos_spin.plot .\plot\dos_pd.d.plot
